...
def parse_args():
  ...
  parser.add_option("-w", "--wait", type="int", default=30,
      help="Number of seconds to wait for cluster nodes to start (default: 60)")
  parser.add_option("-k", "--key-pair", default="admm",
      help="Key pair to use on instances")
  parser.add_option("-i", "--identity-file", default="/Users/jdr/.ec2/admm.pem", 
      help="SSH private key file to use for logging into instances")
  parser.add_option("-t", "--instance-type", default="m1.small",
      help="Type of instance to launch (default: m1.small). " +
           "WARNING: must be 64 bit, thus small instances won't work")
  parser.add_option("-m", "--master-instance-type", default="m1.large",
  ...
  parser.add_option("-o", "--os", default="amazon64",
      help="OS on the Amazon Machine Image (default: admm)")
